...
MISTRAL_API_KEY = 'uQwjntCIJ9omN9z8jLTV1VOUvYlbaDIv'  # Проверьте, что ключ действительный
...
def get_embeddings(texts):
    ...
    data = {
        'model': 'mistral-embed',  # Указываем модель для эмбеддингов
        'input': texts
    }
...
def search_courses(query, courses):
    ...
    similarities = np.nan_to_num(similarities)  # Обрабатываем NaN
